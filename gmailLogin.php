...
session_start();
	include('hybridauth/src/autoload.php');
		...
		*/
		'Google' => [ 
		'enabled' => true,
		'keys'    => [ 'id' => '314639631915-hhfs4p2f33mb8cmh4f6crtb5dj0r257e.apps.googleusercontent.com', 'secret' => '09TXpsFnsqE4aMtq8Gk4MRyS' ],
		],
		...
		*/
		...
		$_SESSION['GmailUserProfile']  = $userProfile;
		
		header("location:social-login-register");
