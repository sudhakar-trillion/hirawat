  ...
  <div class="container-fluid" style="min-height:500px">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-list"></i> <?php echo $text_list; ?>ss</h3>
      </div>
      <div class="panel-body">
        <form id="crosssale_form" method="post" autocomplete="off">
        <div class="form-group">
                <label class="col-sm-2 control-label" ><span data-toggle="tooltip" title="Auto Suggest"><?php echo $product_label; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" placeholder="<?php echo $product_placeholder; ?>"  id="cross-sale-parent-prd" class="form-control cross-sale-parent-prd" value='' />
<span class="cross-sale-parent-prd-error" > </span>
<input type="hidden" id="cross-sale-parent-prd-selected"  />
...
<div class="cross-sale-prd-section col-md-12 sale-prd-section" id="crosssale_remove0">
                ...
                <div class="col-md-2 remlp">
                 ...
                 <div class="col-md-3 ">
<input type="text" name="cross-sale-product" value="" placeholder="<?php echo $cross_product; ?>" id="cross-sale-prd" class="form-control cross-sale-prd" />
<span class="cross-sale-prd-error"> </span>   
<input type="hidden" class="cross-sale-prd-selected" />
			...
			<div class="cross-sale-product-list well well-sm" style="height: 150px; overflow: auto; display:none">
                ...
                <div class="col-md-2 remlp">
                 ...
                 <input type="text" value="" placeholder="Actual Price" class="form-control ActualPrice" id="ActualProducPrice" readonly="readonly"/>
                </div>
                
                <div class="col-md-2 remlp">
                	
                    
				  <input type="text" value="" placeholder="<?php echo $cross_sale_product_price; ?>" class="form-control cross-sale-prd-price" />
                  <span> </span>   
 ...
 <div class="clearfix"></div>                
  ...
  <span class="crosssale_msg"></span>
        <input type="button" class="btn btn-success pull-right submit-cross-sale" value="Add Cross Sale" />
