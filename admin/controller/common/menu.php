...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_product_cross_sale'] = $this->language->get('text_product_cross_sale');
		$data['text_view_cross_sale'] = $this->language->get('text_view_cross_sale');
		...
		$data['text_logistic']			=	$this->language->get('text_logistic');
		$data['text_dtdc']				=	$this->language->get('text_dtdc');
		...
		$data['crosssale'] = $this->url->link('catalog/product_crosssale', 'token=' . $this->session->data['token'], true);
		$data['viewcrosssale'] = $this->url->link('catalog/product_viewcrosssale', 'token=' . $this->session->data['token'], true);

		#$data['report_sale_order'] = $this->url->link('report/sale_order', 'token=' . $this->session->data['token'], true);
		
		$data['report_sale_order'] = $this->url->link('report/sale_orders', 'token=' . $this->session->data['token'], true);
		...
		$data['order_dispatch'] = $this->url->link('dispatch/dtdcorderdispatch', 'token=' . $this->session->data['token'], true);
