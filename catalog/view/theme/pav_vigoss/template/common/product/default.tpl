        ...
        <?php } ?>
          ...
          <div class="action">           
            ...
            <span data-toggle="tooltip" data-placement="top" title="<?php echo $objlang->get('quick_view'); ?>">
             <a class="btn btn-info btn-sm eye-zoom prd-quick-view" viewprdct="<?PHP echo $product['product_id']?>" data-toggle="modal" data-target="#Prdquickview"    ><i class="zmdi zmdi-eye zmdi-hc-fw"></i></a>
             </span>
