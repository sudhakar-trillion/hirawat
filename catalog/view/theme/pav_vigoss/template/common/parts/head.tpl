...
if( file_exists(DIR_TEMPLATE.$themeName.'/stylesheet/material-design-iconic-font.min.css') ) {
    $helper->addCss( 'catalog/view/theme/'.$themeName.'/stylesheet/material-design-iconic-font.min.css'  );
}
...
$logoType = $helper->getConfig('logo_type','logo-theme'); ?>
  <head>
    ...
    <link rel="stylesheet" href="catalog/view/theme/pav_vigoss/stylesheet/jQueryUI.css" />
     <link rel="stylesheet" href="catalog/view/theme/pav_vigoss/stylesheet/owl.carousel.min.css"/>
        
                <link rel="stylesheet" href="catalog/view/theme/pav_vigoss/stylesheet/owl.theme.default.min.css"/>
                
                <link rel="stylesheet" href="catalog/view/theme/pav_vigoss/float-panel/demo2.css"/>

<script src="catalog/view/theme/pav_vigoss/float-panel/float-panel.js"></script>
<script>
$(document).ready(function()
{
 ...
 $(document).on('scroll', function() {
		  ...
		  if( scrollPos > 205 ) {
			  ...
			  $('.menu').addClass('float-panel').addClass('navbar-fixed-top').addClass('fixed').attr('data-top','0');
			 
			
			
			
			$(".scroll-nav").addClass('col-md-2');
			
			$(".shopalzo-menu").addClass('col-md-7');
			$(".top-reg").addClass('col-md-3');
			 ...
			 /* $('.menu').removeClass('navbar-transparent');*/
			 		...
			 		$('.menu').removeClass('float-panel').removeClass('navbar-fixed-top').removeClass('fixed');
			 
			 		$(".scroll-nav").removeClass('col-md-2');
			  		$(".shopalzo-menu").removeClass('col-md-7');
			  		$(".top-reg").removeClass('col-md-3');
