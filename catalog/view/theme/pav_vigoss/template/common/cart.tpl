<div id="cart" class="clearfix common-cart">
      ...
      <div class="cart-inner">
        <a href="">
          ...
          <div class="pull-left  hidden-xs"> 
            <div class="wrap-cart">        
          <span class="text-cart"><?php #echo '<span >My-Cart</span>'; #echo $objlang->get("text_heading_title"); ?></span>
          </div>
          <span id="cart-total" class="cart-total radius-x cart-items"><?php  echo substr( $text_items,0,2); ?></span>
          </div>
        </a>
      </div>
    </div>
  <ul class="dropdown-menu pull-right">
    ...
    <li>
      <div>
        ...
        <p class="text-right"><a href="<?php echo $cart; ?>"><span class="btn btn-primary"><?php echo $text_cart; ?></span></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo $checkout; ?>"><span class="btn btn-danger"><?php echo $text_checkout; ?></span></a></p>
      </div>
    </li>
    <?php } else { ?>
    <li>
