...
<body class="<?php echo $class; ?> layout-<?php echo $template_layout; ?> boxed-container" >
  ...
  <div id="sys-notification">  <div id="notification"></div> </div>
    ...
    <header class="style-header header-v1">
        <div id="top">
         ...
         <div class="col-md-8 col-sm-6 col-xs-12 pl">
								<div class="left-info">
									<ul>
										
										
										<li><i class="fa fa-truck">&nbsp;</i> Free shipping  over Rs.499 per order</li>
                                        	<li><i class="fa fa-refresh">&nbsp;</i>Return & Exchange in 3 working days</li>
                                            	
									</ul>
								</div>
							</div>
          
            <div class=" col-md-4 hidden-xs feel-free pr">
        ...
        <div class="space-padding-tb-20 top-center logo-section">
          <div class="container pl ">
            <div id="logo" class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
            <!-- logo -->
         ...
         <a href="<?php echo $home; ?>" class="img-responsive"><img src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" /></a>
          ...
          <div id="logo" class="col-lg-7 col-md-7 col-sm-6 col-xs-12 pl pr text-right">
...
<!--                
            ...
            <div class="dropdown-menu dropdown-menu-right">                    
              ...
              <?php #echo $currency; ?>                     
                ...
                <div class="sticky-cart"> <?php echo $cart; ?> </div>
