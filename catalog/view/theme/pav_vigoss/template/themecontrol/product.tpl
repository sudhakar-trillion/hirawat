            ...
            <div id="product">
              ...
              <?php } ?>
               ...
               <div class="product-buttons-wrap">
                  ...
                  <span class="outofstockmsg"></span>
                  <div class="clearfix">
                  <div class="pull-left space-right-15">
                  	
                    
                      <button type="button" id="<?PHP if($AvailQuantity>2) {?>button-cart<?PHP }else echo 'button-cart' ?>" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary">
                  ...
                  <div class="pull-left space-right-15">
                      <a data-toggle="tooltip" class="btn btn-sm btn-inverse-light" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><i class="zmdi zmdi-tune zmdi-hc-fw"></i></a>
                  </div>
                  <div class="pull-left">  
                      <a data-toggle="tooltip" class="btn btn-sm btn-inverse-light" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="zmdi zmdi-favorite-outline zmdi-hc-fw"></i></a>
                  </div>
