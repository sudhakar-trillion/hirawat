...
<div class="productdeals panel panel-center <?php echo $addition_cls; ?>">
	<?php if( $show_title ) { ?>
...
<?php if( count($products) > $itemsperpage ) { ?>
  <div class="carousel-controls-v1">
    <a class="carousel-control carousel-sm left" href="#pavdeals<?php echo $id;?>" data-slide="prev"><i class="zmdi zmdi-chevron-left zmdi-hc-fw"></i></a>
    <a class="carousel-control carousel-sm right" href="#pavdeals<?php echo $id;?>" data-slide="next"><i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i></a>
  </div>
...
<?php } ?>
<div class="footer-deals space-20">      
...
<div class="product-meta">        
    ...
    <?php if( !isset($listingConfig['catalog_mode']) || !$listingConfig['catalog_mode'] ) { ?>
        <div class="cart">            
           <button data-loading-text="Loading..." class="btn" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');">
             <i class="zmdi zmdi-plus zmdi-hc-fw"></i><span><?php echo $objlang->get('button_cart'); ?></span>
          </button>
        </div>
    <?php } ?>  
