...
<div class="widget-products product-tabs panel <?php $addition_cls?> <?php if ( isset($stylecls)&&$stylecls) { ?>box-<?php echo $stylecls; ?><?php } ?>">
	<?php if( $show_title ) { ?>
	 ...
	 <div class="tab-content hightlight">
		<?php foreach( $tabs as $tab => $products ) {
			...
			?>
				...
				<a class="carousel-control carousel-sm left" href="#tab-<?php echo $tab.$id;?>"   data-slide="prev"><i class="zmdi zmdi-chevron-left zmdi-hc-fw"></i></a>
				<a class="carousel-control carousel-sm right" href="#tab-<?php echo $tab.$id;?>"  data-slide="next"><i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i></a>
				</div>
				<?php } ?>
				...
				<?php foreach ($pages as  $k => $tproducts ) {   ?>
						<div class="item <?php if($k==0) {?>active<?php } ?>">
							<?php foreach( $tproducts as $i => $product ) {  $i=$i+1;?>
								...
								<?php } ?>
									  <div class="col-lg-<?php echo $span;?> col-md-<?php echo $span;?> col-sm-6 col-xs-12 product-col col">
