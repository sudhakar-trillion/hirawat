...
<div class="<?php echo $prefix; ?>newsletter-v1" id="newsletter_<?php echo $position.$module;?>">
		...
		<div class="panel panel-v1">
			...
			<div class="panel-body">
				<div class="description space-15 space-padding-t5"><?php echo html_entity_decode( $description );?></div> 
                    <input type="text" placeholder="Enter your email here..." class="form-control email space-20" <?php if(!isset($customer_email)): ?> <?php endif; ?> size="18" name="email">
                    <div class="input-group-btn">
                        <button type="submit" name="submitNewsletter" class="btn btn-primary icon-mail"><span>Sign up now !</span>
                        </button>
                    </div>
