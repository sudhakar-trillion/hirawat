        ...
        <fieldset id="account">
         ...
         <?PHP 
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="firstname" value="<?php echo $val; ?>" placeholder="<?php echo $entry_firstname; ?>" id="input-firstname" class="form-control" />
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="lastname" value="<?php echo $val; ?>" placeholder="<?php echo $entry_lastname; ?>" id="input-lastname" class="form-control" />
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="email" name="email" value="<?php echo $val; ?>" placeholder="<?php echo $entry_email; ?>" id="input-email" class="form-control" />
              <?php if ($error_email) { ?>
