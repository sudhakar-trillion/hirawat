  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="mt"><?php echo $content_top; ?>
      ...
      <div class="reg-acount">
        ...
        <?php if ($text_agree) { ?>
        <div class="col-md-6 text-right pull-right pr">
        <div class="buttons">
          <div class="text-left"><?php echo $text_agree; ?>
            <?php if ($agree) { ?>
            ...
            <?php } ?>
            &nbsp;
            <input type="submit" value="<?php echo $button_continue; ?>" class="btn btn-primary reg-button" />
          </div>
        </div>
        </div>
