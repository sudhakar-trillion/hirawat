        ...
        <table class="table table-bordered table-hover add-mywhish">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right"><a href="<?php echo $return['href']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="btn btn-primary cart-del"><i class="fa fa-eye"></i></a></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
