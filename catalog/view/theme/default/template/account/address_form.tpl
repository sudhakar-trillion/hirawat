...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="col-md-8 my-ac-order add-head reg-acount"> <?php echo $content_top; ?>
      <h2 class="text-center mb"><?php echo $text_edit_address; ?></h2>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="buttons no-bg-bt clearfix">
          ...
          <a href="<?php echo $back; ?>" class="btn btn-default con-shaping"><?php echo $button_back; ?></a>
            <input type="submit" value="<?php echo $button_continue; ?>" class="btn btn-primary con-check" />
          </div>
        </div>
      </form>
