...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="col-md-9 my-ac-order reg-acount"><?php echo $content_top; ?>
      <h1 class="text-center " style="margin-bottom:5px"><?php echo $heading_title; ?></h1>
      <p class="text-center mb"><?php echo $text_description; ?></p>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <div class="input-group date"><input type="text" name="date_ordered" value="<?php echo $date_ordered; ?>" placeholder="<?php echo $entry_date_ordered; ?>" data-date-format="YYYY-MM-DD" id="input-date-ordered" class="form-control" /><span class="input-group-btn  bt-cal">
        ...
        <div class="buttons no-bg-bt clearfix">
          ...
          <div class="pull-right">
           <a href="<?php echo $back; ?>" class="btn btn-primary con-shaping"><?php echo $button_back; ?></a>
            <input type="submit" value="<?php echo $button_submit; ?>" class="btn btn-primary con-check" />
          </div>
        </div>
        <?php } ?>
      </form>
