...
<div class="buttons clearfix">
  <div ><?php echo $text_agree; ?> &nbsp;
    <input type="checkbox" name="agree" value="1" class="" style="position:relative; top:2px" />
    <input type="button" value="<?php echo $button_continue; ?>" id="button-register" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary pull-right" />
  </div>
</div>
<?php } else { ?>
<div class="buttons clearfix">
