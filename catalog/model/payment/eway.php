...
class ModelPaymentEway extends Model {
	...
	public function getAccessCode($request) {
		if ($this->config->get('eway_test')) {
			...
			$url = 'http://api.sandbox.ewaypayments.com/AccessCodes';
		} else {
			//$url = 'https://api.ewaypayments.com/AccessCodes';
			$url = 'http://api.ewaypayments.com/AccessCodes';
		}
	...
	public function getSharedAccessCode($request) {
		if ($this->config->get('eway_test')) {
			...
			$url = 'http://api.sandbox.ewaypayments.com/AccessCodesShared';
		} else {
			//$url = 'https://api.ewaypayments.com/AccessCodesShared';
			$url = 'http://api.ewaypayments.com/AccessCodesShared';
		}
	...
	public function getAccessCodeResult($access_code) {
		if ($this->config->get('eway_test')) {
			...
			$url = 'http://api.sandbox.ewaypayments.com/AccessCode/' . $access_code;
		} else {
			//$url = 'https://api.ewaypayments.com/AccessCode/' . $access_code;
			$url = 'http://api.ewaypayments.com/AccessCode/' . $access_code;
		}
