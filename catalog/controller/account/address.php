...
class ControllerAccountAddress extends Controller {
	...
	public function index() {
		if (!$this->customer->isLogged()) {
			...
			$this->session->data['redirect'] = $this->createLink('my-address');
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->createLink('my-address'));
		}
	...
	public function edit() {
		...
		$this->request->get['address_id'] = $crentpge[3];
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$data['addresses'][] = array(
				...
				'update'     => $this->createLink('edit-address')."/".$result['address_id'],
				'delete'     => $this->createLink('delete-address')."/".$result['address_id'],
			);
		}
	...
	protected function getForm() {
		...
		$data['back'] = $this->createLink('my-address');
