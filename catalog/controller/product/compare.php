...
class ControllerProductCompare extends Controller {
	...
	public function add() {
		...
		if ($product_info) {
			...
			$json['success'] = sprintf($this->language->get('text_success'), $this->url->link('product/product', 'product_id=' . $this->request->post['product_id']), $product_info['name'], $this->createLink('compared-products'));
