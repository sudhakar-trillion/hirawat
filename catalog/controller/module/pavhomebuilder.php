...
class ControllerModulepavhomebuilder extends Controller {
	...
	public function index( $setting ) { 
		...
		//get the school categories
		$schoolcategories = $this->model_catalog_category->getSchoolcategories();
		
		/*echo "<pre>";
		print_r($schoolcategories);
		exit;
*/
		...
		$this->mdata['schoolcategories'] =  $schoolcategories;
		//echo $tpl; exit; 
